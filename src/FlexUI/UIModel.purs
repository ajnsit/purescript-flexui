...
import FlexUI.DomClass (GroupFlag(..))
import FlexUI.FlexboxModel (FlexDirectionValue(..), Size)
import FlexUI.FlexboxModel as FM
...
type LPropRow' :: forall k. (Type -> k) -> Row k
type LPropRow' f =
